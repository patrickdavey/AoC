...
`x`, `y`, and `z` position coordinates. A moon's *kinetic energy* is the
sum of the absolute values of its velocity coordinates. Below, each line
shows the calculations for a moon's potential energy (`pot`), kinetic
...
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+Part+One+of+%22The+N%2DBody+Problem%22+%2D+Day+12+%2D+Advent+of+Code+2019&url=https%3A%2F%2Fadventofcode%2Ecom%2F2019%2Fday%2F12&related=ericwastl&hashtags=AdventOfCode)
